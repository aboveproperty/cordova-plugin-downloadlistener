...
var IAB = {
    ...
    injectScriptFile: function (win, fail, args) {
        var msg = 'Browser cordova-plugin-downloadlistener injectScriptFile is not yet implemented';
        console.warn(msg);
        if (fail) {
            fail(msg);
        }
    ...
    injectStyleCode: function (win, fail, args) {
        var msg = 'Browser cordova-plugin-downloadlistener injectStyleCode is not yet implemented';
        console.warn(msg);
        if (fail) {
            fail(msg);
        }
    ...
    injectStyleFile: function (win, fail, args) {
        var msg = 'Browser cordova-plugin-downloadlistener injectStyleFile is not yet implemented';
        console.warn(msg);
        if (fail) {
            fail(msg);
        }
